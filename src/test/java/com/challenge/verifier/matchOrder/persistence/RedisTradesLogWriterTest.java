...
public class RedisTradesLogWriterTest {
    ...
    void appendsLogAndPopsAsFIFO() {
        ...
        assertEquals("trade 10000, 99999, 98, 20", redisTemplate.opsForList().leftPop("TradesLog"));
        assertEquals("trade 10001, 99991, 198, 320", redisTemplate.opsForList().leftPop("TradesLog"));
        assertEquals("trade 10002, 99994, 298, 220", redisTemplate.opsForList().leftPop("TradesLog"));
        assertEquals("trade 10003, 99996, 398, 120", redisTemplate.opsForList().leftPop("TradesLog"));
    }
}
